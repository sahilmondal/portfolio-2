      ...
      <div className="mt-10 flex flex-col items-start gap-8 md:flex-row lg:gap-10 ">
        <div className="top-28 overflow-hidden rounded-md md:sticky md:w-1/2">
          <img
            ref={profile}
            loading="lazy"
            className="aspect-square h-auto w-full rounded-md object-cover object-center grayscale md:aspect-auto"
            src={profileImg}
            width="600"
            height="800"
        ...
        <div className="top-20 sm:sticky md:top-28 md:w-1/2 lg:top-32">
          <div className="w-full space-y-4 2xl:space-y-10">
            ...
            >
              I am an independent Front-end Developer based in Kolkata,India.
              <br></br>
              <br></br>I specialize in crafting elevated, intuitive, and
              minimalistic websites for startups and small businesses to help
